...
app.MapGet("/products", () =>
{
 var products = new List<ProductModel>
    {
        new ProductModel { Id = 1, Title = "buttermilk pancakes", Category = "breakfast", Price = 15.99m, Img = "./images/item-1.jpeg", Desc = "I'm baby woke mlkshk wolf bitters live-edge blue bottle, hammock freegan copper mug whatever cold-pressed" },
    new ProductModel { Id = 2, Title = "diner double", Category = "lunch", Price = 13.99m, Img = "./images/item-2.jpeg", Desc = "vaporware iPhone mumblecore selvage raw denim slow-carb leggings gochujang helvetica man braid jianbing. Marfa thundercats" },
    new ProductModel { Id = 3, Title = "godzilla milkshake", Category = "shakes", Price = 6.99m, Img = "./images/item-3.jpeg", Desc = "ombucha chillwave fanny pack 3 wolf moon street art photo booth before they sold out organic viral." },
    new ProductModel { Id = 4, Title = "country delight", Category = "breakfast", Price = 20.99m, Img = "./images/item-4.jpeg", Desc = "Shabby chic keffiyeh neutra snackwave pork belly shoreditch. Prism austin mlkshk truffaut" },
    new ProductModel { Id = 5, Title = "egg attack", Category = "lunch", Price = 22.99m, Img = "./images/item-5.jpeg", Desc = "franzen vegan pabst bicycle rights kickstarter pinterest meditation farm-to-table 90's pop-up" },
    new ProductModel { Id = 6, Title = "oreo dream", Category = "shakes", Price = 18.99m, Img = "./images/item-6.jpeg", Desc = "Portland chicharrones ethical edison bulb, palo santo craft beer chia heirloom iPhone everyday" },
...
app.MapPost("/orders", ([FromBody] List<CartItem> cartItems) =>
{
